...
Partial Public Class DbDataSet
    ...
    Partial Public Class LoginDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddLoginRow(ByVal LoginId As String, ByVal Password As String, ByVal Admin As Short, ByVal UserName As String) As LoginRow
            Dim rowLoginRow As LoginRow = CType(Me.NewRow,LoginRow)
            Dim columnValuesArray() As Object = New Object() {LoginId, Password, Admin, UserName}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByLoginId(ByVal LoginId As String) As LoginRow
        ...
        Private Sub InitClass()
            ...
            Me.columnAdmin = New Global.System.Data.DataColumn("Admin", GetType(Short), Nothing, Global.System.Data.MappingType.Element)
    ...
    Partial Public Class LoginRow
        ...
        Public Property LoginId() As String
            Get
                Return CType(Me(Me.tableLogin.LoginIdColumn),String)
            End Get
            Set
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Property Admin() As Short
            Get
                Try 
                    Return CType(Me(Me.tableLogin.AdminColumn),Short)
                Catch e As Global.System.InvalidCastException
...
Namespace DbDataSetTableAdapters
    ...
    Partial Public Class LoginTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Login` WHERE ((`LoginId` = ?) AND ((? = 1 AND `Password` IS NULL) OR"& _ 
                " (`Password` = ?)) AND ((? = 1 AND `Admin` IS NULL) OR (`Admin` = ?)) AND ((? = "& _ 
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Admin", Global.System.Data.OleDb.OleDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Admin", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Login` (`LoginId`, `Password`, `Admin`, `UserName`) VALUES (?, ?, ?,"& _ 
                " ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Admin", Global.System.Data.OleDb.OleDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Admin", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Login` SET `LoginId` = ?, `Password` = ?, `Admin` = ?, `UserName` = ? WHE"& _ 
                "RE ((`LoginId` = ?) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND"& _ 
                " ((? = 1 AND `Admin` IS NULL) OR (`Admin` = ?)) AND ((? = 1 AND `UserName` IS NU"& _ 
                "LL) OR (`UserName` = ?)))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Admin", Global.System.Data.OleDb.OleDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Admin", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Admin", Global.System.Data.OleDb.OleDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Admin", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Sentiment_Analyzer_V1.My.MySettings.Default.DbConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT LoginId, [Password], Admin, UserName FROM Login"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DbDataSet.LoginDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DbDataSet.LoginDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DbDataSet.LoginDataTable = New DbDataSet.LoginDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DbDataSet.LoginDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_LoginId As String, ByVal Original_Password As String, ByVal Original_Admin As Global.System.Nullable(Of Short), ByVal Original_UserName As String) As Integer
            ...
            If (Original_Admin.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_Admin.Value,Short)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal LoginId As String, ByVal Password As String, ByVal Admin As Global.System.Nullable(Of Short), ByVal UserName As String) As Integer
            ...
            If (Admin.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(Admin.Value,Short)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal LoginId As String, ByVal Password As String, ByVal Admin As Global.System.Nullable(Of Short), ByVal UserName As String, ByVal Original_LoginId As String, ByVal Original_Password As String, ByVal Original_Admin As Global.System.Nullable(Of Short), ByVal Original_UserName As String) As Integer
            If (LoginId Is Nothing) Then
                Throw New Global.System.ArgumentNullException("LoginId")
            Else
            ...
            End If
            If (Admin.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(Admin.Value,Short)
            Else
            ...
            If (Original_LoginId Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_LoginId")
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_LoginId,String)
            End If
            If (Original_Password Is Nothing) Then
            ...
            If (Original_Admin.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_Admin.Value,Short)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Password As String, ByVal Admin As Global.System.Nullable(Of Short), ByVal UserName As String, ByVal Original_LoginId As String, ByVal Original_Password As String, ByVal Original_Admin As Global.System.Nullable(Of Short), ByVal Original_UserName As String) As Integer
            Return Me.Update(Original_LoginId, Password, Admin, UserName, Original_LoginId, Original_Password, Original_Admin, Original_UserName)
        End Function
    End Class
